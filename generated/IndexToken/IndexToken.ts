...
export class IndexToken__checkpointsResult {
  value0: BigInt;
  value1: BigInt;
...
export class IndexToken extends ethereum.SmartContract {
  static bind(address: Address): IndexToken {
    return new IndexToken("IndexToken", address);
  }
  ...
  checkpoints(param0: Address, param1: BigInt): IndexToken__checkpointsResult {
    let result = super.call(
      "checkpoints",
    ...
    return new IndexToken__checkpointsResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_checkpoints(
    param0: Address,
    param1: BigInt
  ): ethereum.CallResult<IndexToken__checkpointsResult> {
    let result = super.tryCall(
      "checkpoints",
      "checkpoints(address,uint32):(uint32,uint96)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new IndexToken__checkpointsResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
